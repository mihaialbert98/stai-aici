      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-sm leading-relaxed text-gray-700">
          <section>
            ...
            <p>
              The StayBird platform is operated by <strong>ABT SOFTWARE HUB SRL</strong> (hereinafter referred to as &quot;the Controller&quot;).
          ...
          <section>
            ...
            <p>
              We use one essential session cookie (<code className="text-xs bg-gray-100 px-1 py-0.5 rounded">staybird-token</code>) required
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-sm leading-relaxed text-gray-700">
        <section>
          ...
          <p>
            Platforma StayBird este operata de <strong>ABT SOFTWARE HUB SRL</strong> (denumita in continuare &quot;Operatorul&quot;).
        ...
        <section>
          ...
          <p>
            Folosim un cookie esential de sesiune (<code className="text-xs bg-gray-100 px-1 py-0.5 rounded">staybird-token</code>) necesar
